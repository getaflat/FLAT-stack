...
public class DatabaseLoader implements CommandLineRunner {
    ...
    public void run(String... strings) throws Exception {
        ...
        c0.setLastName("Wisoky");
        c0.setFirstName("Marcos");
        c0.setEmail("marcos.wisoky@mail.com");
        c0.setDateOfBirth(new Date(90, 0, 1));
        c0.setPassword(passwordEncoder.encode("passwort"));
		...
		c1.setLastName("Larson");
		c1.setFirstName("Cleve");
		c1.setEmail("cleve.larson@mail.com");
		c1.setDateOfBirth(new Date(91, 0, 1));
		c1.setPassword(passwordEncoder.encode("passwort"));
		c1.setTotalScore(400);
		this.cRepository.save(c1);

        Customer c2 = new Customer();
        c2.setContractNumber(123456789012L);
        c2.setLastName("Boyer");
        c2.setFirstName("Georgianna");
        c2.setEmail("georgianna.boyer@mail.com");
        c2.setDateOfBirth(new Date(92, 1, 2));
        c2.setPassword(passwordEncoder.encode("passwort"));
        c2.setTotalScore(500);
        this.cRepository.save(c2);

        Customer c3 = new Customer();
        c3.setContractNumber(123456789013L);
        c3.setLastName("Blick");
        c3.setFirstName("Lorenza");
        c3.setEmail("lorenza.blick@mail.com");
        c3.setDateOfBirth(new Date(93, 2, 3));
        c3.setPassword(passwordEncoder.encode("passwort"));
        ...
        c4.setLastName("Carroll");
        c4.setFirstName("Robert");
        c4.setEmail("robert.carroll@mail.com");
        c4.setDateOfBirth(new Date(94, 3, 4));
        c4.setPassword(passwordEncoder.encode("passwort"));
        c4.setTotalScore(700);
        this.cRepository.save(c4);

        Customer c5 = new Customer();
        c5.setContractNumber(123456789015L);
        c5.setLastName("Mills");
        c5.setFirstName("Flossie");
        c5.setEmail("flossie.mills@mail.com");
        c5.setDateOfBirth(new Date(95, 4, 5));
        c5.setPassword(passwordEncoder.encode("passwort"));
        c5.setTotalScore(800);
        this.cRepository.save(c5);

        Customer c6 = new Customer();
        c6.setContractNumber(123456789016L);
        c6.setLastName("Rogahn");
        c6.setFirstName("Juliana");
        c6.setEmail("juliana.rogahn@mail.com");
        c6.setDateOfBirth(new Date(96, 5, 6));
        c6.setPassword(passwordEncoder.encode("passwort"));
        c6.setTotalScore(300);
        this.cRepository.save(c6);

        Customer c7 = new Customer();
        c7.setContractNumber(123456789017L);
        c7.setLastName("Harber");
        c7.setFirstName("Richmond");
        c7.setEmail("richmond.harber@mail.com");
        c7.setDateOfBirth(new Date(97, 6, 7));
        c7.setPassword(passwordEncoder.encode("passwort"));
        c7.setTotalScore(200);
        this.cRepository.save(c7);

        Customer c8 = new Customer();
        c8.setContractNumber(123456789018L);
        c8.setLastName("Shanahan");
        c8.setFirstName("Maxie");
        c8.setEmail("maxie.shanahan@mail.com");
        c8.setDateOfBirth(new Date(98, 7, 8));
        c8.setPassword(passwordEncoder.encode("passwort"));
        c8.setTotalScore(800);
        this.cRepository.save(c8);

        Customer c9 = new Customer();
        c9.setContractNumber(123456789019L);
        c9.setLastName("Frami");
        c9.setFirstName("Felicita");
        c9.setEmail("felicita.frami@mail.com");
        c9.setDateOfBirth(new Date(99, 8, 9));
        c9.setPassword(passwordEncoder.encode("passwort"));
        c9.setTotalScore(1000);
        this.cRepository.save(c9);

        Customer c10 = new Customer();
        c10.setContractNumber(123456789020L);
        c10.setLastName("Bayer");
        c10.setFirstName("Lamar");
        c10.setEmail("lamar.bayer@mail.com");
        c10.setDateOfBirth(new Date(90, 0, 1));
        c10.setPassword(passwordEncoder.encode("passwort"));
        ...
        c11.setLastName("Heidenreich");
        c11.setFirstName("Noelia");
        c11.setEmail("noelia.heidenreich@mail.com");
        c11.setDateOfBirth(new Date(91, 0, 1));
        c11.setPassword(passwordEncoder.encode("passwort"));
        c11.setTotalScore(400);
        this.cRepository.save(c11);

        Customer c12 = new Customer();
        c12.setContractNumber(123456789022L);
        c12.setLastName("Blanda");
        c12.setFirstName("Brando");
        c12.setEmail("brando.blanda@mail.com");
        c12.setDateOfBirth(new Date(92, 1, 2));
        c12.setPassword(passwordEncoder.encode("passwort"));
        c12.setTotalScore(500);
        this.cRepository.save(c12);

        Customer c13 = new Customer();
        c13.setContractNumber(123456789023L);
        c13.setLastName("Tillman");
        c13.setFirstName("Karli");
        c13.setEmail("karli.tillman@mail.com");
        c13.setDateOfBirth(new Date(93, 2, 3));
        c13.setPassword(passwordEncoder.encode("passwort"));
        ...
        c14.setLastName("Hauck");
        c14.setFirstName("Cara");
        c14.setEmail("cara.hauck@mail.com");
        c14.setDateOfBirth(new Date(94, 3, 4));
        c14.setPassword(passwordEncoder.encode("passwort"));
        c14.setTotalScore(700);
        this.cRepository.save(c14);

        Customer c15 = new Customer();
        c15.setContractNumber(123456789025L);
        c15.setLastName("Kihn");
        c15.setFirstName("Pearlie");
        c15.setEmail("pearlie.kihn@mail.com");
        c15.setDateOfBirth(new Date(95, 4, 5));
        c15.setPassword(passwordEncoder.encode("passwort"));
        c15.setTotalScore(800);
        this.cRepository.save(c15);

        Customer c16 = new Customer();
        c16.setContractNumber(123456789026L);
        c16.setLastName("Hahn");
        c16.setFirstName("Beau");
        c16.setEmail("beau.hahn@mail.com");
        c16.setDateOfBirth(new Date(96, 5, 6));
        c16.setPassword(passwordEncoder.encode("passwort"));
        c16.setTotalScore(300);
        this.cRepository.save(c16);

        Customer c17 = new Customer();
        c17.setContractNumber(123456789027L);
        c17.setLastName("Huels");
        c17.setFirstName("Keshaun");
        c17.setEmail("keshaun.huels@mail.com");
        c17.setDateOfBirth(new Date(97, 6, 7));
        c17.setPassword(passwordEncoder.encode("passwort"));
        c17.setTotalScore(200);
        this.cRepository.save(c17);

        Customer c18 = new Customer();
        c18.setContractNumber(123456789028L);
        c18.setLastName("Walsh");
        c18.setFirstName("Hadley");
        c18.setEmail("hadley.walsh@mail.com");
        c18.setDateOfBirth(new Date(98, 7, 8));
        c18.setPassword(passwordEncoder.encode("passwort"));
        c18.setTotalScore(800);
        this.cRepository.save(c18);

        Customer c19 = new Customer();
        c19.setContractNumber(123456789029L);
        c19.setLastName("Douglas");
        c19.setFirstName("Christa");
        c19.setEmail("christa.douglas@mail.com");
        c19.setDateOfBirth(new Date(99, 1, 18));
        c19.setPassword(passwordEncoder.encode("passwort"));
